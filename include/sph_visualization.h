...
public:
    SPHVisualization2D() {_sph_system_data = std::make_shared<SPHSystemDatad>(); }
    ~SPHVisualization2D() {}
    ...
    std::shared_ptr<SPHSystemDatad> sph_data() { return _sph_system_data; }
...
private:
    std::shared_ptr<SPHSystemDatad> _sph_system_data;
};
